...
# Bộ ảnh phòng LEGACY của SHOP GỐC (homestay Haru/Mochi) — hằng DÙNG CHUNG cho
# mọi adapter (trước đây 7 kênh mỗi kênh chép 1 bản, sửa 1 quên 6). Chỉ hội
# thoại _default_shop được đụng kho media legacy này (brain đã gate).
LEGACY_ROOM_SETS = [("haru", "Haru Staycation"), ("mochi", "Mochi Home")]
